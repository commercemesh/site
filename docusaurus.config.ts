...
const config: Config = {
  ...
  organizationName: 'commercemesh', // Usually your GitHub org/user name.
  projectName: 'commercemesh-site', // Usually your repo name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/commercemesh/commercemesh-site/tree/main/',
        },
        blog: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/commercemesh',
          label: 'GitHub',
          position: 'right',
        },
      ],
